...
namespace NSerializer.Migration
{
    public interface IMigrationDefinition
    {
        ...
        ITypeDefinition GetTypeDefinition<T>();
        void AddChild(IVersionQualifier qualifier, IMigrationDefinition childDefinition);
        ITypeDefinition GetTypeDefinition(string name);
        ITypeDefinition GetTypeDefinition(Type type);
        ITypeNameMapper GetTypeNameMapper();
        bool HasTypeDefinition(Type soughtType);
    }
}