...
{
    public abstract class MemberWriterTestFixture : NXmlTestFixtureBase
    {
        protected IObjectWriter objectWriter;
        protected IDocumentWriter ownerDocument;
        protected IValueMemberWriter writer;
        ...
        protected abstract IValueMemberWriter GetWriter();
    }
}